...
dataset_root = '/home/clientmlp/FIDS/Data/NSL-KDD-Dataset'
...
with open("/home/clientmlp/FIDS/Data/NSL-KDD-Dataset/training_attack_types.txt", 'r') as f:
...
if __name__ == "__main__":
    ...
    disp = plot_confusion_matrix(test_Y, nn_pred, cmap=plt.cm.Greens, text_fontsize='medium',
    ...
    class FlowerClient(fl.client.NumPyClient):
        ...
        y_train = train_Y_bin.values
        X_test = test_x.values
        y_test = test_Y_bin.values
        model = MLPClassifier(alpha=1e-5, hidden_layer_sizes=(1000, 5), max_iter=1000, random_state=1)
    ...
    fl.client.start_numpy_client(client=FlowerClient(), server_address=server_address)
