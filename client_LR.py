...
dataset_root = '/home/clientlr/FIDS/Data/NSL-KDD-Dataset'
...
with open("/home/clientlr/FIDS/Data/NSL-KDD-Dataset/training_attack_types.txt", 'r') as f:
...
if __name__ == "__main__":
    ...
    disp = plot_confusion_matrix(test_Y, pred_y, cmap=plt.cm.Greens, text_fontsize='medium',
...
class FlowerClient(fl.client.NumPyClient):
    ...
    def evaluate(self, parameters, config):  # type: ignore
        #utils.set_model_params(clf_lr, parameters)
        #loss = log_loss(test_Y, model.predict_proba(test_x))
        loss = 0.01
        score = accuracy_score(test_Y, pred_y)
        return get_parameters(config), len(train_x), {"accuracy": score * 100}
